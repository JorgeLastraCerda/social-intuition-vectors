...
| `fig18_hiring_disparity.{png,pdf}` | Historical four-model figure with a legacy mixed-unit contract (model gaps in within-model SD units, human reference in percentage points); preserved for provenance and not regenerated for the active manuscript |
...
| `fig_warmth_steering_fragility_9model.{png,pdf,py}` | 3×3 small-multiples grid of warmth local-regime dose-response (mean Δ callback margin vs. steering strength) across nine models; monotone panels in blue, non-monotone/fragile panels in red; Gemma-3-12B panel uses the broad regime (no local run exists for that model); supports `2026-08-06_1333_warmth_steering_fragility_scale_9model.md` |
...
| `2026-06-27_1757_probe_human_data_audit.md` | 2026-06-27 17:57 | Gemma-3-12B · Gemma-3-27B · Llama-3.1-8B · Qwen3-14B | Data-quality audit for Test 2 probe-vs-human alignment: Gallo & Hausladen name ratings + model concept vectors; scored rubric (8.0/10), limitations, acceptance decision | Corrected 2026-08-06; all tables recomputed after the flake_leasure/kline duplication bug fix (`src/build_probe_human_data_audit_stats.py`), no conclusion changes. |
| `2026-06-30_1251_r4_disparity_name_level.md` | 2026-06-30 12:51 | Gemma-3-12B · Gemma-3-27B | R4 disparity: group-level (race × gender) and name-level OLS joining model callback margins with Gallo & Hausladen human callback benchmark; 149/282 names matched | Superseded 2026-08-06; legacy `concept_vectors*` inputs left untouched, current source of truth is `2026-06-27_1541_hiring_phase7_4model.md` and the canonical gemma3_12b/27b R4 tables (246/186, up from 149). |
...
| `2026-07-15_0035_gemma4_transformerlens_pipeline.md` | 2026-07-15 00:35 | Gemma-4-31B · Gemma-4-26B-A4B | TransformerLens Bridge implementation and gated SCCKN replication workflow | Implementation complete; SCCKN smoke and production runs pending; R4-join figure corrected 2026-08-06 (149→246 observations). |
...
| `2026-07-18_2314_gemma4_12b_posthoc_hiring.md` | 2026-07-18 23:14 | Gemma-4-12B-it | Demographic disparity, mediation, group R4, and name-level R4 | Complete; 269-name disparity/mediation join validated. R4 paragraph corrected 2026-08-06 (246/186, up from 149). |
...
| `2026-07-18_2335_gemma4_26b_a4b_posthoc_hiring.md` | 2026-07-18 23:35 | Gemma-4-26B-A4B-it | Demographic disparity, mediation, group R4, and name-level R4 | Complete; two mediation intervals exclude zero. R4 paragraph corrected 2026-08-06 (246/186, up from 149; warmth now also significant). |
| `2026-07-18_2335_gemma4_31b_posthoc_hiring.md` | 2026-07-18 23:35 | Gemma-4-31B-it | Demographic disparity, mediation, group R4, and name-level R4 | Complete; competence is the strongest name-level correlate. R4 paragraph corrected 2026-08-06 (246/186, up from 149). |
...
| `2026-07-19_0953_qwen36_27b_posthoc_hiring.md` | 2026-07-19 09:53 | Qwen3.6-27B | Demographic disparity, mediation, group R4, and name-level R4 | Complete; competence mediation intervals exclude zero, while model-human name-level callback alignment is weak. R4 paragraph corrected 2026-08-06 (246/186, up from 149; eleven race-gender-study groups, up from four). |
...
| `2026-07-19_1006_qwen36_35b_a3b_posthoc_hiring.md` | 2026-07-19 10:06 | Qwen3.6-35B-A3B | Demographic disparity, mediation, group R4, and name-level R4 | Complete; warmth mediation intervals exclude zero. R4 paragraph corrected 2026-08-06 (246/186, up from 149; human-callback correlation now weakly significant). |
...
| `2026-07-20_1935_probe_human_result_tables.md` | 2026-07-20 19:35 | 9 Gemma, Qwen, and Llama checkpoints | Consolidated probe-vs-human correlation and race/gender disparity tables added to the manuscript, plus a probe-layer-selection Limitations addition | Corrected 2026-08-06; a flake_leasure/kline duplication bug in Carina Hausladen's own ratings data prep silently double-weighted Kline for some names and dropped 37 genuine Kline names from Table 3, fixed in `src/utils/human_ratings.py` and `src/hiring_r4.py`, original values retained for history. |
...
| `2026-08-13_1816_manuscript_table_figure_revision.md` | 2026-08-13 18:16 | 9 Gemma, Qwen, and Llama checkpoints | Jorge handover implementation: compact tables, corrected transition summaries, active figure regeneration, manuscript integration, and layout verification | Corrected and superseded for gap units and final layout by the 2026-08-14 report. |
| `2026-08-14_1236_pooled_disparity_float_round_a.md` | 2026-08-14 12:36 | 9 Gemma, Qwen, and Llama checkpoints | Common pooled within-group SD contract for model and human callback gaps, plus rendered two-round float evaluation | Complete; comparable gap contract and 34-page final layout verified. |
| `2026-08-14_1458_manuscript_consistency_corrections.md` | 2026-08-14 14:58 | 9 Gemma, Qwen, and Llama checkpoints | Correct probe-depth, steering, alignment, ablation, validation-count, and callback-resolution manuscript claims | Complete; source values, generated caption, 12 tests, and 34-page PDF verified. |
| `2026-08-14_1720_manuscript_closeout_corrections.md` | 2026-08-14 17:20 | 9 Gemma, Qwen, and Llama checkpoints | Close remaining table semantics, result counts, mediation inference language, corpus terminology, and appendix-order inconsistencies | Complete; 16 focused tests, 111 project-test passes, and a visually verified 34-page PDF. Supersedes the prior Bonferroni interpretation. |
| `2026-08-14_1735_manuscript_claim_scope_corrections.md` | 2026-08-14 17:35 | 9 Gemma, Qwen, and Llama checkpoints | Correct the competence human-alignment counts in Introduction and Discussion, and narrow the construct-scope claims in the Discussion opener and Conclusion | Complete; 18 focused tests, 113 project-test passes, and a 34-page PDF with appendix order re-verified. Supersedes "competence tracks human ratings in every checkpoint". |
| `2026-08-17_1650_main_body_word_limit_revision.md` | 2026-08-17 16:50 | 9 Gemma, Qwen, and Llama checkpoints | First restructuring pass for a strict 8,000-word main-body limit | Superseded by the 17:23 rebuild; retained for provenance after its 5,621-word main body was judged too short. |
| `2026-08-17_1723_main_body_rebuild_from_long.md` | 2026-08-17 17:23 | 9 Gemma, Qwen, and Llama checkpoints | Rebuild the active manuscript directly from the immutable `_long` source under the 8,000-word inclusive limit | Superseded by the 17:30 figure-restoration pass; retained as the direct-from-archive rebuild record. |
| `2026-08-17_1730_main_figure_restoration_acknowledgements_appendix.md` | 2026-08-17 17:30 | 9 Gemma, Qwen, and Llama checkpoints | Restore the emotion-vector and cross-model agreement figures to the main body and move Acknowledgements to the appendix | Superseded for final table/reference layout verification by the 17:45 audit; its 7,867-word main-body result remains current. |
| `2026-08-17_1745_table_reference_caption_audit.md` | 2026-08-17 17:45 | 9 Gemma, Qwen, and Llama checkpoints | Audit every active table, label, reference, appendix framing statement, caption position, and rendered order | Complete; all 22 tables present, S.16 verified on page 30, captions below every table, appendix order S.1 through S.17, and a visually verified 32-page PDF. |
| `2026-08-17_2101_post_pull_build_word_count.md` | 2026-08-17 21:01 | 9 Gemma, Qwen, and Llama checkpoints | Pull the collaborator's latest cross-reference fixes, rebuild the active PDF, and separate the visible word-count budget | Complete; additive main total is 7,789, the conservative compliance ledger is 7,871, and the rebuilt 32-page PDF is clean. |
