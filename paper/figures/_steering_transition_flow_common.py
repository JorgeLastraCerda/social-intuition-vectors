...
MODEL_ROWS = (
    (
        ...
        ModelSpec("Llama-3.1-8B", "Llama-3.1", "hiring_steering_raw_llama31_8b.csv", 0.50),
    ),
    (
    ...
    (
        ModelSpec("Qwen3-14B", "Qwen3", "hiring_steering_raw_qwen3_14b.csv", 0.50),
...
EXPECTED_MEANS = {
    ...
    ("Llama-3.1-8B", "warmth"): (-2.097916666666667, 1.0729166666666667),
    ("Llama-3.1-8B", "competence"): (-2.097916666666667, 0.071875),
    ...
    ("Qwen3-14B", "warmth"): (1.7041666666666666, 2.3041666666666667),
    ("Qwen3-14B", "competence"): (1.7041666666666666, 1.3208333333333333),
...
def _expected_counts() -> dict[tuple[str, str], Counter[tuple[str, str]]]:
    ...
    expected[("Llama-3.1-8B", "warmth")] = Counter({("No", "Yes"): 60})
    expected[("Llama-3.1-8B", "competence")] = Counter(
        {("No", "No"): 15, ("No", "Tie"): 10, ("No", "Yes"): 35}
    )
    unchanged_models = (
        "Gemma-4-12B",
        "Gemma-4-26B-A4B",
