...
Read this file at the start of every session. This repository is now the active workspace for the third project:
...
This project is expected to run primarily on the Universität Konstanz SCCKN cluster.
